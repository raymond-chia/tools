...
7. 禁止進入內建 plan mode。
8. 禁止未讀 [docs/gdext.md](docs/gdext.md) 就撰寫或修改 `godot_bind/` 的程式碼。
...
參考 gdext 寫法。撰寫或修改 `godot_bind/` 中任何與 Godot 綁定相關的程式碼前，必須先閱讀 [docs/gdext.md](docs/gdext.md)。該檔案只記載易錯處，不是完整教學。
