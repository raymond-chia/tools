...
fn test_resolve_hit() {
    ...
    let test_data = [
        ...
        // 數值上會閃避，但骰子 96 強制命中
        // 閃避歸零不會暴擊
        (0, 999, 0, 0, 100, HitCheckResult::Hit { crit: false }),
        (0, 999, 0, 0, 99, HitCheckResult::Hit { crit: false }),
        (0, 999, 0, 0, 98, HitCheckResult::Hit { crit: false }),
        (0, 999, 0, 0, 97, HitCheckResult::Hit { crit: false }),
        (0, 999, 0, 0, 96, HitCheckResult::Hit { crit: false }),
        // 骰子 95 不觸發強制命中，正常閃避
        (0, 999, 0, 0, 95, HitCheckResult::Evade),
        //
        // --- 強制閃避（骰子 1~5）---
        // 數值上會命中，但骰子 1~5 強制閃避
        (999, 0, 0, 0, 1, HitCheckResult::Evade),
        (999, 0, 0, 0, 2, HitCheckResult::Evade),
        (999, 0, 0, 0, 3, HitCheckResult::Evade),
        (999, 0, 0, 0, 4, HitCheckResult::Evade),
        (999, 0, 0, 0, 5, HitCheckResult::Evade),
        // 骰子 6 不觸發強制閃避，正常命中
        (999, 0, 0, 0, 6, HitCheckResult::Hit { crit: false }),
        //
        // --- 暴擊（命中時）---
        // 暴擊門檻 10
        // 暴擊
        (50, 30, 20, 10, 100, HitCheckResult::Hit { crit: true }),
        (50, 30, 20, 10, 95, HitCheckResult::Hit { crit: true }),
        (50, 30, 20, 10, 90, HitCheckResult::Hit { crit: true }),
        // 不暴擊
        (50, 30, 20, 10, 89, HitCheckResult::Hit { crit: false }),
        (50, 30, 20, 10, 80, HitCheckResult::Hit { crit: false }),
        (50, 30, 20, 10, 70, HitCheckResult::Hit { crit: false }),
        // 暴擊門檻 20
        // 暴擊
        (50, 30, 20, 20, 100, HitCheckResult::Hit { crit: true }),
        (50, 30, 20, 20, 90, HitCheckResult::Hit { crit: true }),
        (50, 30, 20, 20, 80, HitCheckResult::Hit { crit: true }),
        // 不暴擊
        (50, 30, 20, 20, 79, HitCheckResult::Hit { crit: false }),
        (50, 30, 20, 20, 60, HitCheckResult::Hit { crit: false }),
        (50, 30, 20, 20, 50, HitCheckResult::Hit { crit: false }),
        //
        // --- 暴擊 + 格擋 ---
        // 格擋
